...
import FilterDapilComponent from "./filter";
...
export default function DashboardDapilComponent() {
  ...
  return (
    <div className="bg-white">
      <div className="font-bold mb-3.5">Dapil</div>
      <FilterDapilComponent />
      <Table>
        <TableHeader>
          <TableRow>
        ...
        <TableBody>
          {dapil?.items?.map((item, idx) => (
            <TableRow key={idx}>
              ...
              <TableCell className="py-3">{item.kecamatan[0].name}</TableCell>
        ...
        <DialogPortal>
          <DialogContent className="DialogContent max-w-[39rem] dialog-no-close">
            <DialogTitle className="DialogTitle">
              <h2 className="text-lg">Edit Dapil</h2>
            </DialogTitle>
            <div className="DialogDescription">
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                />
                <label className="text-sm text-sm">Kecamatan</label>
                ...
                <Select>
                  <SelectTrigger className="rounded-2xl mb-4 mt-0.5">
                    {selectedItems.length > 0 ? (
                      ...
                      <p className="!text-[#535353]">Masukkan Nama Kecamatan</p>
                    )}
                  </SelectTrigger>
                  <SelectContent>
