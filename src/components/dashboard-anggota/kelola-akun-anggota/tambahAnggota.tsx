...
export default function DashboardTambahAkunAnggotaComponent() {
  const {
    register,
    handleSubmit,
    reset,
  ...
  const onSubmit = (data: any) => {
    ...
    formData.append("address", "jl. jalan1");
    formData.append("dateOfBirth", "1998-01-01");
  ...
  return (
    <>
      ...
      <div className="font-bold mb-3.5">Tambah Akun Anggota</div>
      <form onSubmit={handleSubmit(onSubmit)}>
        <label className="text-sm text-sm">Nama Lengkap</label>
        <Input
          type="text"
        ...
        />
        <label className="text-sm text-sm">Nomor Telepon</label>
        <Input
          type="text"
        ...
        <select className="w-full border border-solid border-[#dddddd] rounded-2xl py-2 text-sm mt-1 mb-4 px-2">
