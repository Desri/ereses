...
export default function DashboardInformasiSummaryComponent({ user }: Props) {
        ...
        <table>
          <tbody>
            ...
            <tr>
              ...
              <td className="px-1.5 pb-2.5">:</td>
              <td className="pb-2.5">{user.nip}</td>
            </tr>
            <tr>
              <td className="pb-2.5">
              ...
              <td className="px-1.5 pb-2.5">:</td>
              <td className="pb-2.5">50 Tahun</td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              ...
              <td className="px-1.5 pb-2.5">:</td>
              <td className="pb-2.5">{user.dapil?.name}</td>
            </tr>
            <tr>
              <td className="pb-2.5">
              ...
              <td className="px-1.5 pb-2.5">:</td>
              <td className="pb-2.5">{user.fraksi?.name}</td>
            </tr>
            <tr>
              <td className="pb-2.5">
