...
import { registerSekretariatSchema } from "@/schema/registerSekretariatSchema";
import { z } from "zod";
import { zodResolver } from "@hookform/resolvers/zod";
import { showSuccessToast } from "@/utils/toast";

type RegisterSekretariatInput = z.infer<typeof registerSekretariatSchema>;

export default function RegisterSekretariatComponent() {
  ...
  const {
    ...
    control,
    formState: { errors },
  } = useForm<RegisterSekretariatInput>({
    resolver: zodResolver(registerSekretariatSchema),
  });
      ...
      <div>
        <div className="py-6 px-5 sm:px-10">
          ...
          <p className="text-[#473D3D]">
            Register sebagai Sekretariat untuk memantau, memverifikasi dan
        ...
        <div className="h-full bg-center bg-no-repeat bg-cover bg-[url('/assets/bg-pattern.png')]">
          <div className="pt-11 sm:pt-16 px-5 sm:px-10">
            <h2 className="text-3xl leading-10 mb-5 text-white">
              Selamat Datang di Dashboard Sekretariat
            ...
            <p className="text-sm text-center pb-4 text-white mt-16">
              Sudah punya akun?{" "}
              <Link href="/login-sekretariat" className="font-bold underline">
                Masuk
              </Link>
            </p>
          </div>
